...
import paduru from '../assets/paduru.png'; // Import the paduru image

export default function EventPage() {
	const { id } = useParams();
	const [event, setEvent] = useState(null);

	// Fetch the event data from the server by ID
	useEffect(() => {
		if (!id) return;
	...
	// While data is loading, you can render a loader or simply nothing
	...
	return (
		<div className="flex flex-col mx-5 xl:mx-32 md:mx-10 mt-5 flex-grow">
			...
			{/* Demo image, imported from assets */}
			<img
				src={paduru}
				alt="Demo"
				className="rounded object-fill aspect-16:9"
